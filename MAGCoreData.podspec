#
#  Be sure to run `pod spec lint MAGCoreData.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Ievgen Rudenko"
  # s.authors            = { "Ievgen Rudenko" => "mail@erudenko.com" }
  # s.social_media_url   = "http://twitter.com/Ievgen Rudenko"
  ...
  s.source       = { :git => "https://github.com/MadAppGang/MAGCoreData.git", :tag => "0.0.1" }
